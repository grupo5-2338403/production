    ...
    <form action="./enviar.php" method="POST" class="formulario">
        ...
        <div class="a1">
            ...
            <div>
                ...
                <a href="../Configuracion_estado_actualizar/index.php?id_estado=<?php echo $product -> id_estado?> & nombre_estado=<?php echo $product->nombre_estado?>" class="boton_cancelar boton_selec">Editar</a>
                <a href="./borrar.php?id_estado=<?php echo $product -> id_estado ?>" class="boton_cancelar boton_selec">Borrar</a>
